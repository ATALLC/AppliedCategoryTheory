...
INCLUDE_ROOTS := AGENTS.md README.md Makefile archive demos katas logseq/pages pages resources sessions
INCLUDE_PATTERNS := *.md *.org Makefile
...
pack:
	...
	@find $(INCLUDE_ROOTS) \
		\( -type d \( -name node_modules -o -name .git -o -name '.*' \) \) -prune -o \
